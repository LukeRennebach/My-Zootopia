...
def find_names(data):
    ...
    return [animal.get("name") for animal in data]


def find_diet(data):
    """Return a list of diets for the animals."""
    return [animal["characteristics"].get("diet") for animal in data]
...
def find_type(data):
    ...
    return [animal["characteristics"].get("type") for animal in data]
